...
(function() {
  ...
  document.querySelector('.form-aspirasi-btn').addEventListener('click', function() {
    document.getElementById('formAspirasi').style.display = 'block';
  });
  ...
  window.onclick = function(event) {
    ...
    if (event.target !== formAspirasi && !formAspirasi.contains(event.target) && event.target !== document.querySelector('.form-aspirasi-btn')) {
      formAspirasi.style.display = 'none';
    }
  }
